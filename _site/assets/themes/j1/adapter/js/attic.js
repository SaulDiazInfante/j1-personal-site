      ...
      var frontmatterOptions = _this.frontmatterOptions;
          ...
          if ($('#home_attic').length) {
            ...
            if (typeof atticOptions.slides != 'undefined') {
              ...
              $(function() {
                // logger.debug('\n' + 'Load image header on: ' + home_attic);
                logger.debug('\n' + 'Load image header');
         ...
         // END if header enabled
          ...
          if ($('#image_attic').length) {
            ...
            if (typeof atticOptions.slides != 'undefined') {
              // Load the image header if the page is ready (visible)
              $(function() {
                // logger.debug('\n' + 'Load image header on: ' + image_attic);
                logger.debug('\n' + 'Load image header');
         ...
         // END if header enabled
          ...
          if ($('#text_attic').length) {
            ...
            if (typeof atticOptions.slides != 'undefined') {
              // Load the image header if the page is ready (visible)
              $(function() {
                // logger.debug('\n' + 'Load image header on: ' + text_attic);
                logger.debug('\n' + 'Load image header');
