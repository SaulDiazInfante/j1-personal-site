    ...
    generate_scrollers: function () {
      ...
      var dependencies_met_page_ready = setInterval (function (options) {
        if (j1.getState() === 'finished') {
          ...
          var container = '#' + 'home_service_panel';
          // scroller_id: home_service_panel
          logText = '\n' + 'scroller of type showOnScroll is being initialized on: ' + 'home_service_panel';
          logger.info(logText);
          // Create an scroller instance of showOnScroll if container exists
          if ($(container).length) {
            $(container).scroller({
          ...
          // END scroller_id: home_service_panel
          ...
          if (language === 'en') {
            ...
            lastPageInfo += 'More articles can be found with the <a href="/pages/public/blog/navigator/" class="link-no-decoration">Blog Navigator</a>';
            lastPageInfo += '</p></div>';
          } else if (language === 'de') {
            lastPageInfo =  '<div class="page-scroll-last"><p class="infinite-scroll-last">';
            lastPageInfo += 'Weitere Artikel finden Sie im <a href="/pages/public/blog/navigator/" class="link-no-decoration">Blog Navigator</a>';
            lastPageInfo += '</p></div>';
          } else {
            lastPageInfo =  '<div class="page-scroll-last"><p class="infinite-scroll-last">';
            lastPageInfo += 'More articles can be found with the <a href="/pages/public/blog/navigator/" class="link-no-decoration">Blog Navigator</a>';
