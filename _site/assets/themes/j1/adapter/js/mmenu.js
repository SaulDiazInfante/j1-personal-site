  ...
  return {
    ...
    mmenuInitializer: function (mmOptions) {
      ...
      if ($('#navigator_sidebar_mmenu').length) {
        logger.info('\n' + 'mmenu is being initialized on id: navigator_sidebar_mmenu');
         // ENDIF content_type: NAVIGATION
          // Create an mmenu instance of type HTML
          logger.info('\n' + 'found content type: DRAWER');
          // -------------------------------------------------------------------
          ...
          // NOTE: Run load check (j1.xhrDataState) before initialization
          //
          logger.info('\n' + 'initialize mmenu on id: #navigator_sidebar_mmenu');
          var dependencies_met_navigator_sidebar_mmenu_loaded = setInterval (function () {
            if (j1.xhrDataState['#navigator_sidebar_mmenu'] == 'success' &&
                $('#navbar-brand').length) {
              ...
              // set an id on the drawer wrapper div for later use
              //
              drawer_navigator_sidebar_mmenu.wrapper.id = 'drawer_navigator_sidebar_mmenu';
              // monitor for state changes on the drawer
              //
              ...
              logger.debug('\n' + 'met dependencies for: navigator_sidebar_mmenu loaded');
              clearInterval(dependencies_met_navigator_sidebar_mmenu_loaded);
              $('#sidebar_mmenu').show();
          }; // END if menu_loaded
        }, 25); // END dependencies_met_mmenu_loaded
        logger.info('\n' + 'initializing mmenu finished on id: #navigator_sidebar_mmenu');
         // ENDIF content_type: DRAWER
        } // END menus|drawers
       // ENDIF menu enabled
       // ENDFOR menus
